...
- `PostgresEventBridge`: `PostgresEventBridge('postgresql://user:pass@localhost:5432/mydb')` (default table `bubus_events`) or `PostgresEventBridge('postgresql://user:pass@localhost:5432/dbname/tablename')` (override table)
