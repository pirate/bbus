---
title: Inspiration And License
description: Project inspiration and licensing details.
---
...
TypeScript package follows the same project-level license and repository metadata.
