---
title: Performance And Runtimes
description: Runtime support, performance notes, and benchmark snapshots.
---
...
- `AsyncLocalStorage` is preserved at emit time and used during handling when availabe (Node/Bun), otel/tracing context will work normally in those environments
